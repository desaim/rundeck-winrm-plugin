...
public class OTWinRMNodeExecutor implements NodeExecutor, Describable {
    ...
    public static final String WINRM_MODE = "winrm-mode";
    public static final String WINRM_MODE_NATIVE = "native";
    public static final String WINRM_MODE_INTERNAL = "internal";
    ...
    public static final String DEFAULT_WINRM_MODE = WINRM_MODE_INTERNAL;
    ...
    private static final String CONFIG_WINRM_MODE = "winrmMode";
    ...
    static final Description DESC = DescriptionBuilder.builder()
	    ...
	    .property(PropertyUtil.select(CONFIG_WINRM_MODE, "WinRM Mode", "Select Internal if Rundeck instance is running on non-Windows hosts. \n\n" +
		    "Select Native if Rundeck instance is running on Windows server", true, DEFAULT_WINRM_MODE, Arrays.asList(WINRM_MODE_NATIVE, WINRM_MODE_INTERNAL)))
	    ...
	    .mapping(CONFIG_WINRM_MODE, PROJ_PROP_PREFIX + WINRM_MODE)
    ...
    protected class ConnectionOptionsBuilder {
       ...
       public String getwinrmMode() {
	    ...
	    final boolean isInternal = WINRM_MODE_INTERNAL.equalsIgnoreCase(getwinrmMode());
